...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`sitea4` /*!40100 DEFAULT CHARACTER SET utf8mb4 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `actividad_clase` (
  ...
  `PERIODO_ACTIVIDAD_CLASE` VARCHAR(45) NULL,
  `FECHA_ACTIVIDAD_CLASE` DATE NOT NULL,
  `DUA_ACTIVIDAD_CLASE` VARCHAR(200) NULL,
  `DESCRIPCION_ACTIVIDAD_CLASE` VARCHAR(500) NOT NULL,
  `DIARIO_PEDAGOGICO` VARCHAR(100) NULL,
...
CREATE TABLE `boletin_academico` (
  `ID_BOLETIN_ACADEMICO` INT NOT NULL AUTO_INCREMENT,
  `FECHA_BOLETIN` DATE NULL,
  ...
  `NOVEDADES_REPORTES_ID_NOVEDADES_REPORTES` INT NULL,
...
CREATE TABLE `estudiante` (
  ...
  `TIPO_DOCUMENTO_ID_TIPO_DOCUMENTO` int(11) DEFAULT NULL,
...
CREATE TABLE `evaluacion` (
  ...
  `BOLETIN_ACADEMICO_ID_BOLETIN_ACADEMICO` int NOT NULL,
  `PIAR_SEGUIMIENTO_EVALUATIVO` int NOT NULL,
...
CREATE TABLE `matricula` (
  ...
  `INSTITUCION_ID_INSTITUCION` int NOT NULL,
  `ESTUDIANTE_ID_ESTUDIANTE` int NOT NULL,
  `FECHA_REGISTRO_ID_FECHA_REGISTRO` int NULL,
...
CREATE TABLE `piar` (
  `ID_PIAR` int NOT NULL AUTO_INCREMENT,
  ...
  `ESTUDIANTE_ID_ESTUDIANTE` int NOT NULL,
  `SEGUIMIENTO_EVALUATIVO` int NULL,
  PRIMARY KEY (`ID_PIAR`),
  KEY `ESTUDIANTE_ID_ESTUDIANTE` (`ESTUDIANTE_ID_ESTUDIANTE`),
...
CREATE TABLE `protocolos_rutas` (
  ...
  `NOVEDADES_REPORTES_ID_NOVEDADES_REPORTES` int NOT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `FECHA_REGISTRO_ID_FECHA_REGISTRO` date NULL,
