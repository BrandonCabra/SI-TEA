...
CREATE TABLE `boletin_académico` (
  ...
  CONSTRAINT `boletin_académico_ibfk_1` FOREIGN KEY (`NOVEDADES_REPORTES_ID_NOVEDADES_REPORTES`) REFERENCES `NOVEDADES_REPORTES` (`ID_NOVEDADES_REPORTES`),
...
CREATE TABLE `estudiante` (
  ...
  `FOTOGRAFIA_ESTUDIANTE` VARCHAR (100) NULL,
  `numero_documento_padre` VARCHAR(45) DEFAULT NULL,
  `TIPO_DOCUMENTO_ID_TIPO_DOCUMENTO` VARCHAR(45) NOT NULL,
...
CREATE TABLE `institucion` (
  ...
  CONSTRAINT `institucion_ibfk_1` FOREIGN KEY (`ID_INSTITUCION`) REFERENCES `REPRESENTANTE_LEGAL` (`ID_REPRESENTANTE_LEGAL`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `novedades_reportes` (
  ...
  `ACCIONES_NOVEDADES_REPORTES` text NOT NULL,
  `TIPO_NOVEDADES_REPORTES` enum('Académica','Conductual','Médica','Psicológica','NuevoEstudianteTEA','Otra') NOT NULL,
  `DESCRIPCION_NOVEDADES_REPORTES` text NOT NULL,
  `ESTADO_NOVEDADES_REPORTES` enum('Pendiente','En proceso','Resuelto') NOT NULL DEFAULT 'Pendiente',
...
CREATE TABLE `REPRESENTANTE_LEGAL` (
  ...
  `CORREO_REPRESENTANTE_LEGALcol` varchar(45) NOT NULL,
  `INSTITUCION_ID_INSTITUCION` int NOT NULL,
