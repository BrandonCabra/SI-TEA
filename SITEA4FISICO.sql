...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`sitea4.0` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `actividad_clase` (
  ...
  CONSTRAINT `actividad_clase_ibfk_1` FOREIGN KEY (`PIAR_ID_PIAR`) REFERENCES `piar` (`ID_PIAR`)
...
CREATE TABLE `caracterizacion` (
  ...
  `ESTUDIANTE_ID_ESTUDIANTE` int NOT NULL,
  `CÓDIGO_CARACTERIZACION` varchar(45) NOT NULL,
  `CONTEXTO_ACADEMICO` varchar(200) NOT NULL,
  `CONTEXTO_FAMILIAR` varchar(200) NOT NULL,
  `CONTEXTO_ESCOLAR` varchar(200) NOT NULL,
  `DIAGNOSTICO` varchar(45) NOT NULL,
  `VALORACIÓN_PEDAGOGICA` varchar(300) NOT NULL,
  `BARRERAS DE APRENDIZAJE` varchar(200) NOT NULL,
  `RECOMENDACIONES` varchar(100) NOT NULL,
  `CORRESPONSABILIDAD` varchar(100) NOT NULL,
...
CREATE TABLE `piar` (
  ...
  `PERIODO_PIAR` varchar(45) NOT NULL,
  `CODIGO_PIAR` int NOT NULL,
  `DBA` text NOT NULL,
  `BARRERAS APRENDIZAJE_PIAR` varchar(45) NOT NULL,
  `FLEXIBILIZACION_PIAR` varchar(45) NOT NULL,
  `ESTUDIANTE_ID_ESTUDIANTE` int NOT NULL,
