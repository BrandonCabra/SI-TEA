        ...
        <div class="row">
            <div class="col-12 col-md-4 col-lg-3">
                <div class="m-lg-1 bg-primary text-white p-5 rounded-3">
                    <div class="list-group">
                        ...
                        <a href="../vistas/Modulos.php" class="list-group-item list-group-item-action bg-primary text-white">
                        ...
                        <a href="../index2.html" class="list-group-item list-group-item-action bg-primary text-white"><img
                        ...
                        <div class="mt-5">
                            <a href="../controladores/logout.php"
                                class="list-group-item list-group-item-action bg-primary text-white"><img
                                    ...
                                    style="width: 20px; height: auto;">Cerrar Sesión</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card" style="width: 23rem; height: 412px">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-primary">Instituciones Educativas</h5>
                        <p class="card-text">En este módulo encontrara la caracterización de IE.</p>
                ...
                <div class="card" style="width: 23rem; height: 412px">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-primary">SEGURIDAD</h5>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="card" style="width: 23rem; height: 412px">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-primary">GESTION PROFESORES</h5>
                ...
                <div class="card" style="width: 23rem; height: 412px">
                    ...
                    <div class="card-body">
                        <h5 class="card-title text-primary">PERMISOS</h5>
